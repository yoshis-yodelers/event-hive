  ...
  render() {
    return (
      ...
      <View style={styles.view}>
        ...
        <TextInput style = {styles.input} value = {this.state.start.length > 2 ? this.state.start+' '+ this.state.shour+":" +this.state.sminute + this.state.sampm: ''} onFocus = {() => this.setState({startshow: true})}/>
        <Modal visible = {this.state.startshow}>
          <View style = {{top: 20}}>
            <View style = {{justifyContent: "space-between", paddingHorizontal: 10, flexDirection: "row"}}>
              <Button title = "Back" onPress = {() => {this.setState({startshow: false})}}/>
        ...
        <Picker style = {{width: 100}} style = {{width: 100}} selectedValue={this.state.start.length > 2 ? this.state.sampm : ''}
          onValueChange={(itemValue) =>
        ...
        <TextInput style = {styles.input} value = {this.state.end.length > 2 ? this.state.end + ' ' + this.state.ehour + ":" + this.state.eminute + this.state.eampm: ''} onFocus = {() => this.setState({endshow:true})}/>
        ...
        <Button title = "Back" onPress = {() => this.setState({endshow: false})}/>
        ...
        <Picker style = {{width: 100}} style = {{width: 100}} selectedValue={this.state.start.length > 2 ? this.state.eampm : ''}
          onValueChange={(itemValue) =>
